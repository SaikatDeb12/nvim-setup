...
vim.opt.foldmethod = "indent" --To fold a block of code
vim.opt.foldlevel = 99 -- ensures folds are open when you open a file
vim.opt.foldenable = false -- disables folding on startup, you can enable manually
